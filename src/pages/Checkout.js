...
<div className='grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5'>
    ...
    <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-3xl py-5 font-semibold leading-7 text-gray-900">Personal Information</h2>
      ...
      {addresses.map(({id,name,street,city,pinCode,state,phone}) => (
        <li key={id} className="flex justify-between px-5 gap-x-6 py-5">
          <div className="flex min-w-0 gap-x-4">
          <input
                  name="address"
                    type="radio"
                    className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600 border-solid border-2"
                  />

              <p className="text-sm font-semibold leading-6 text-gray-900">{name}</p>
            <div className="min-w-0 flex-auto">
              <p className="text-sm font-semibold leading-6 text-gray-900">{street}</p>
              <p className="mt-1 truncate text-xs leading-5 text-gray-500">{city}</p>
              <p className="mt-1 truncate text-xs leading-5 text-gray-500">{state}</p>
            </div>
          </div>
          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
            <p className="text-sm leading-6 text-gray-900">Phone No: {phone}</p>
         
              <div className="mt-1 flex items-center gap-x-1.5">
                <div className="flex-none rounded-full bg-emerald-500/20 p-1">
                  <div className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
                </div>
                <p className="text-xs leading-5 text-gray-500">pinCode: {pinCode}</p>
              </div>
