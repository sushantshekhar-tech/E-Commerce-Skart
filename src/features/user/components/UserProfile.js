...
export default function UserProfile() {
  ...
  //TODO : we will work on payment section when we will work on the backend

  //useState for showing which forms need to be edited
  const [selectedEditIndex, setSelectedEditIndex] = useState("-1");
  //State used for adding the address
  ...
  const handleEdit = (addressUpdate, index) => {
    const newUser = { ...user, addresses: [...user.addresses] }; // Proper shallow copy of addresses array
        ...
        <button
          ...
          {user.addresses.map((address, index) => (
            <div>
              ...
              <p className="mt-0.5 text-sm text-gray-500 mb-5">
                Your Addresses:
              </p>
              <div
