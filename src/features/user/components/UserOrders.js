...
export default function UserOrders() {
  ...
  //To check if the order recieved is a array or not
          ...
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
              ...
              <p className="mt-0.5 text-sm text-gray-900">
                Payment Method as on the checkout : {order.paymentMethod}
              </p>
              <p className="mt-0.5 text-sm text-gray-500">
                Shipping Address as given on the checkout:
              </p>
              {order.selectedAddress ? (
                ...
                <p className="mt-0.5 text-sm text-red-500">Shipping address information is missing.</p>
              )}
            </div>
          </div>
        </div>
